...
public class PersonneApp0 {
	...
	public static void main(String[] args) {
		...
		pers1.afficherDetails("en");

		System.out.println();
		Personne pers2 = new Personne("redator", "hamza", "reda");

		System.out.println();
		pers2.majusc();
		pers2.afficherDetails("de");
...
//		if (pers4 == pers5) { // test l'égalité des références et non des attributs
//			System.out.println("les 2 références sont identiques");
//		}
//
